...
TARGET_CXXFLAGS += "${LIBRETRO_EXTRA_CXXFLAGS} ${LIBRETRO_EXTRA_COMPILATION_FLAGS} ${LIBRETRO_COMMON_CXXFLAGS}"
TARGET_CFLAGS += "${LIBRETRO_EXTRA_CXXFLAGS} ${LIBRETRO_EXTRA_COMPILATION_FLAGS} ${LIBRETRO_COMMON_CXXFLAGS}"
