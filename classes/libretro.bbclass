...
LIBRETRO_MAKEFILE_CXXFLAGS ??= "CXXFLAGS=${CXXFLAGS} ${LIBRETRO_EXTRA_CXXFLAGS} ${LIBRETRO_COMMON_CXXFLAGS}"
LIBRETRO_MAKEFILE_CFLAGS ??= "CFLAGS=${CFLAGS} ${LIBRETRO_EXTRA_CFLAGS} ${LIBRETRO_COMMON_CFLAGS}"
...
# https://stackoverflow.com/questions/2129391/append-to-gnu-make-variables-via-command-line
  unset CXXFLAGS CFLAGS ASFLAGS

  export CXXFLAGS="${LIBRETRO_MAKEFILE_CXXFLAGS#*=}"
  export CFLAGS="${LIBRETRO_MAKEFILE_CFLAGS#*=}"
  export ASFLAGS="${LIBRETRO_MAKEFILE_ASFLAGS#*=}"

  export CXX="${CXX} ${CXXFLAGS} ${LIBRETRO_EXTRA_CXXFLAGS} ${LIBRETRO_COMMON_CXXFLAGS}"
  export CC="${CC} ${CFLAGS} ${LIBRETRO_EXTRA_CFLAGS} ${LIBRETRO_COMMON_CFLAGS}"
